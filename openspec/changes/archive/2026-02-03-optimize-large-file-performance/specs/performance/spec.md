...
Performance requirements and guarantees for xlex-core operations.
...
| Operation | File Size | Max Time | Max Memory |
|-----------|-----------|----------|------------|
| `Workbook::open()` | 100MB | 5s | 300MB |
| `Workbook::open()` | 300MB | 10s | 600MB |
| `Workbook::open_lazy()` | 300MB | 1s | 50MB |
| `stream_rows()` iteration | Any | Streaming | Constant |
| `sheet_names()` | 300MB | 2s | 50MB |
| Single cell access (cached) | Any | 1ms | N/A |
